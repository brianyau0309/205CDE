...
--
-- Host: localhost:3306
-- Generation Time: Apr 02, 2019 at 12:21 AM
...
INSERT INTO `admin` (`adminID`, `account`, `password`, `client`, `article`, `news`, `carousel`, `comment`, `revenue`, `admin`) VALUES
(1, 'admin1', 'admin1', 'RW', 'RW', 'RW', 'RW', 'RW', 'R', 'Super'),
(2, 'admin2', 'admin2', 'N', 'R', 'R', 'R', 'R', 'R', 'Normal');
...
INSERT INTO `client` (`email`, `nickname`, `password`, `clientID`) VALUES
('brianyauu@gmail.com', 'Brian', '00000000', 1),
('hello@123', 'Yau', '1234', 2),
('ha@asd', 'Peter', '12345678', 3),
('tony@ggmail', 'Tony', '12345678', 4);
...
INSERT INTO `news` (`newsID`, `date`, `title`, `content`, `author`, `type`) VALUES
...
(3, '2019-04-01 18:55:41', 'New Event!', 'Content:\r\nnoun\r\n1. Usually contents.\r\n\r\n    something that is contained: the contents of a box.\r\n    the subjects or topics covered in a book or document.\r\n    the chapters or other formal divisions of a book or document: a table of contents. \r\n\r\n2. something that is to be expressed through some medium, as speech, writing, or any of various arts: a poetic form adequate to a poetic content. \r\n\r\n3. significance or profundity; meaning: a clever play that lacks content. \r\n\r\n4. substantive information or creative material viewed in contrast to its actual or potential manner of presentation: publishers, record companies, and other content providers; a flashy website, but without much content. ', 1, 'event'),
(4, '2019-04-01 18:57:09', 'System news', 'A system is a group of interacting or interrelated entities that form a unified whole. A system is delineated by its spatial and temporal boundaries, surrounded and influenced by its environment, described by its structure and purpose and expressed in its functioning. ', 1, 'system');
...
--
ALTER TABLE `cart`
  MODIFY `inCartID` int(11) NOT NULL AUTO_INCREMENT;
--
